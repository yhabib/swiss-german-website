...
| Variable | Purpose |
| --- | --- |
| `PUBLIC_SITE_URL` | Optional canonical-site override. Defaults to `https://swiss-german.app`. |
...
| `PUBLIC_SUPPORT_URL` | Optional public support request URL override. Defaults to emailing `support@swiss-german.app`. Never point this to a private repository. |

Canonical, sitemap, and social metadata default to
`https://swiss-german.app`.
